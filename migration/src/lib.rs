...
mod m20250817_000001_add_stripe_transactions;
mod m20250817_000002_add_month_cards;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250817_000001_add_stripe_transactions::Migration),
            Box::new(m20250817_000002_add_month_cards::Migration),
        ]
    }
}
